...
public class MainActivity extends AppCompatActivity {
    ...
    private void anhXa() {
        ...
        arrayImage.add(new hinhAnh(R.drawable.americano,"Phạm Phong Hào",""));
        arrayImage.add(new hinhAnh(R.drawable.cappucino,"Cafe Đen",""));
        arrayImage.add(new hinhAnh(R.drawable.chocomilk,"chocomilk",""));
        arrayImage.add(new hinhAnh(R.drawable.esspresso,"Trà Chanh",""));
        arrayImage.add(new hinhAnh(R.drawable.latte,"Sữa",""));
